...
//---------------------------------------------------------------------------
 ...
 typedef struct DataStruct
	{
		int Intensity; //Интенсивность в этот год
		int Year;      //Год
	};

/*Создаю массив, состоящий из структур(Intensiti и Year), в котором будут
  храниться исходные данные*/
...
String CCText;//Переменная для хранения значения при редактировании ячейки в таблице
DynamicArray<DataStruct> Data;
int rowNmbAndSortKind; //Для определения вида сортировки
